...
let gameBase = [
    stage1 = [
        'ARRAY', 'JAVASCRIPT', 'SCARCE', 'GLOBE', 'CSS', 'BOOTSTRAP', 'CLEARED', 'HTML', 'WEBSITE', 'FUNCTION'
    ],
    stage2 = [
        'DOWNLOAD', 'PYTHON', 'REACT', 'ANGULAR', 'TYPESCRIPT', 'GITHUB', 'LOGICAL', 'HUMBLE', 'NETLIFY', 'UNFOLD'
    ],
    stage3 = [
        'SOFTWARE', 'CLEARANCE', 'LARAVEL', 'JSON', 'C++', 'DEPARTMENT', 'FLOWERS', 'SQUARES', 'BITTER', 'ACTIVATED'
    ],
    stage4 = [
